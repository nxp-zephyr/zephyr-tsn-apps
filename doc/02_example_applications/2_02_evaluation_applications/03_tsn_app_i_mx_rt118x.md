...
The application implements the [TSN application](../2_01_application_components/03_tsn_app.md) and supports the following platforms and configurations:
...
<div align="center">
<figure>
<img src="../../media/figure14.svg" width="513" height="348" />
<figcaption><p>TSN Application Software Architecture on i.MX RT1180 EVK (Singlecore)</p></figcaption>
</figure>
</div>
...
<div align="center">
<figure>
<img src="../../media/figure10.svg" width="513" height="348" />
<figcaption><p>TSN Application Software Architecture on i.MX RT1180 EVK (Multicore)</p></figcaption>
</figure>
</div>

Cortex-M33 is running the TSN Isochronous application described above, which includes:
...
Cortex-M7 is running the TSN Isochronous application, which includes:
